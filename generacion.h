...
*/
void declarar_variable(FILE* fpasm, char * nombre, TIPO tipo, int tamano);/*1*/
...
alfalib.o
*/
void escribir_inicio_main(FILE* fpasm);/*1*/
...
*/
void escribir_operando(FILE* fpasm, char* nombre, int es_variable);/*1*/
...
*/
void sumar(FILE* fpasm, int es_variable_1, int es_variable_2);/*1*/
void restar(FILE* fpasm, int es_variable_1, int es_variable_2);
void multiplicar(FILE* fpasm, int es_variable_1, int es_variable_2);/*1*/
void dividir(FILE* fpasm, int es_variable_1, int es_variable_2);
void o(FILE* fpasm, int es_variable_1, int es_variable_2);/*1*/
void y(FILE* fpasm, int es_variable_1, int es_variable_2);
void cambiar_signo(FILE* fpasm, int es_variable);/*1*/
...
*/
void igual(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);/*1*/
void distinto(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);
void menor_igual(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);/*1*/
void mayor_igual(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);
void menor(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);/*1*/
void mayor(FILE* fpasm, int es_variable1, int es_variable2, int etiqueta);  /* Hasta aqui*/
...
*/
void ifthenelse_inicio(FILE * fpasm, int exp_es_variable, int etiqueta);/*1*/
...
*/
void ifthenelse_fin_then( FILE * fpasm, int etiqueta);/*1*/
...
/*
  ...
  • exp_es_variable
      ...
      ◦ Es 0 en caso contrario (constante u otro tipo de expresión)
*/
void while_exp_pila (FILE * fpasm, int exp_es_variable, int etiqueta);/*1*/
...
/*
    ...
    • Función para poder asignar a un destino que no es una variable “global” (tipo _x) por ejemplo parámetros o variables globales (ya que en ese caso su nombre real de alto nivel, no se tiene en cuenta pues es realmente un desplazamiento a partir de ebp: ebp+4 o ebp-8 por ejemplo.
